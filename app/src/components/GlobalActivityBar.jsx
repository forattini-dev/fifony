...
export function GlobalActivityBar({ issues }) {
  ...
  return (
    <div className="flex items-center gap-2 text-xs">
      {running > 0 && (
        <span className="inline-flex items-center gap-1 text-primary font-medium global-activity-pill">
          <Play size={10} className="fill-current" />
          <span className="tabular-nums">{running}</span>
          <span className="opacity-60 hidden sm:inline">running</span>
        </span>
      )}
      {queued > 0 && (
        <span className="inline-flex items-center gap-1 text-info font-medium">
          ...
          <span className="opacity-60 hidden sm:inline">queued</span>
        </span>
      )}
      {planning > 0 && (
        <span className="inline-flex items-center gap-1 text-info font-medium">
          ...
          <span className="opacity-60 hidden sm:inline">planning</span>
        </span>
      )}
      {reviewing > 0 && (
        <span className="inline-flex items-center gap-1 text-secondary font-medium">
          ...
          <span className="opacity-60 hidden sm:inline">reviewing</span>
        </span>
      )}
      {blocked > 0 && (
        <span className="inline-flex items-center gap-1 text-error font-medium">
          ...
          <span className="opacity-60 hidden sm:inline">blocked</span>
        </span>
      )}
      {totalActive > 0 && (
