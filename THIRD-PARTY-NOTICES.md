...
- **Copyright**: msitarzewski and contributors
...
The skill catalog references the Impeccable design skill system for frontend
development guidance including typography, color, spatial design, motion, and
UX writing reference documentation.
